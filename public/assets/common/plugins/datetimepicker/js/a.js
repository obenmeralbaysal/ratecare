...
`);
            ...
            jQuery.ajax({
                ...
                data: {
                    _token: '{{ csrf_token() }}',
                    startDate: jQuery('#hoteldigilab-startDate').val(),
                    endDate: jQuery('#hoteldigilab-endDate').val(),
                    currency: jQuery('#hoteldigilab-currencies').val(),
                    type: 'pageLoad'
                },
            ...
            jQuery('.hoteldigilab-widget').delay(2000).animate({'right': '0px'}, 1000).delay({
            {
                $main_widget->duration
            }
        }
            000
        ).
            animate({'right': '-275px'}, 1000);
