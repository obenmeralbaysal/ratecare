...
<div class="page-loader-wrapper">
    <div class="loader">
        <div class="m-t-30"><img src="{{ asset("assets/common/img/logo-goz.png") }}" width="48" alt="Alpino"></div>
        <p>Please wait...</p>
    </div>
</div>
        ...
        <ul class="nav navbar-nav">
            <li>
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="{{ route("reseller.dashboard") }}"><img height="60" src="@if(user()->logo) {{ asset("logo") . "/" . user()->logo }} @else {{ asset("assets/common/img/logo.png") }} @endif" alt="Alpino"></a>
                </div>
            </li>
...
<div class="menu-container">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <ul class="h-menu">
                    <li class="open active"><a href="{{ route("reseller.dashboard") }}"><i class="zmdi zmdi-home"></i></a></li>
                    <li><a href="javascript:void(0)">Users</a>
                        <ul class="sub-menu">
                            <li><a href="{{ route("reseller.users.index") }}">All Users</a></li>
                            <li><a href="{{ route("reseller.users.create") }}">New User</a></li>
                            <li><a href="{{ route("reseller.users.invite") }}">Invite User</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
